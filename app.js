...
app.use(express.urlencoded({extended: false})) // accepting data from HTML form (body request data)
app.use(express.json()) // accepting JSON data

app.use('/api', require('./router-api'))

let sessionOptions = session({
    secret: "JavaScript is sooooo coool",
...
app.use(function(req, res, next) {
    ...
    // make all error and sccess flash messages available from all templates
