...
export default class RegistrationForm {
    ...
    usernameImmediately() {
        if (this.username.value != "" && !/^([a-zA-Z0-9]+)$/.test(this.username.value)) { // regular expression
            this.showValidationError(this.username, "Username can only conatain letters and numbers.")
        }
